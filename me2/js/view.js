    ...
    return _.inherit({
        ...
        createRoot: function (html) {
            ...
            if (this.selector) {
                ...
                this.$el.addClass('cm-view');
                this.$el.addClass('page-' + this.viewId);
        ...
        _initComponent: function () {
            ...
            var el, attributes, attr, param, clazz, i, len, tmp, id, name;
            ...
            for (key in components) {
                ...
                attributes = clazz.prototype.props;

                //首先获取标签dom元素,因为html是不区分大小写的,这里将标签小写
